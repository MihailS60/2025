class House:
    ...
    def print_report(self,name,number_fl):
...
h1.print_report(h1.name,h1.number_of_floors)

h2 = House('ЖК Акация', second=20)
h2.print_report(h1.name,h2.number_of_floors)

h3 = House('ЖК Матрёшки', second=20)
h3.print_report(h3.name,h3.number_of_floors)
